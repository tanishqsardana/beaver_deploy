...
The rest of this page is documentation to help you understand what the tool does. Briefly, this tool allows users to:
...
We use the Google Earth Engine Python API to acess various data sources and perform analyses. Users work through the app according to the following steps:
